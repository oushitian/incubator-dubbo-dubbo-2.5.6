...
public class ReferenceConfig<T> extends AbstractReferenceConfig {
    ...
    private T createProxy(Map<String, String> map) {
        ...
        if (isJvmRefer) {
            ...
            if (urls.size() == 1) {
                //这里的refprotocol又是什么呢？Protocol@Adaptive,url又是registry://..，所以最终会调用registry$Adaptive的refer方法
                //invoker=MockClusterInvoker(FailoverClusterInvoker)
                invoker = refprotocol.refer(interfaceClass, urls.get(0));//获得invoke代理对象
            } else {
        ...
        // 创建服务代理
        //proxyFactory又是个自适应扩展点，ProxyFactory$Adaptive
        ...
        //    }
        //所以这里最终会得到javassistProxyFactory的getProxy方法
